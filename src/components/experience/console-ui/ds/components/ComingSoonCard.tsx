...
function ComingSoonCard() {
  return (
    <LiquidGlassCard className="flex h-full flex-row items-center justify-center rounded-2xl border border-zinc-200/50 px-6 text-lg text-zinc-50 shadow-xl transition-all duration-300 select-none">
